...
mod __parse__Query {
    ...
    mod __ascent {
        ...
        mod __parse__Query {
            ...
            //     WillProduce = None
            //
            //     Keyword = (*) "INSERT" ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //     Keyword = (*) r#"(?i)select"# ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //     Keyword = (*) UPDATE ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //     Query = (*) Keyword Table ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //     __Query = (*) Query ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   "INSERT" -> S3
            //   r#"(?i)select"# -> S4
            //   UPDATE -> S5
            ...
            //
            //     Query = Keyword (*) Table ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //     Table = (*) r#"(?i)[a-z]+"# ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   r#"(?i)[a-z]+"# -> S7
            //
            //     Table -> S6
            ...
            //     __Query = Query (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF] -> __Query = Query => ActionFn(0);
            //
            pub fn __state2<
                'input,
                __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__lalrpop_util::ParseError<usize, (usize, &'input str), ()>>>,
            ...
            //     Keyword = "INSERT" (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF] -> Keyword = "INSERT" => ActionFn(2);
            //
            pub fn __state3<
                'input,
                __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__lalrpop_util::ParseError<usize, (usize, &'input str), ()>>>,
            ...
            //     Keyword = r#"(?i)select"# (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF] -> Keyword = r#"(?i)select"# => ActionFn(1);
            //
            pub fn __state4<
                'input,
                __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__lalrpop_util::ParseError<usize, (usize, &'input str), ()>>>,
            ...
            //     Keyword = UPDATE (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF] -> Keyword = UPDATE => ActionFn(3);
            //
            pub fn __state5<
                'input,
                __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__lalrpop_util::ParseError<usize, (usize, &'input str), ()>>>,
            ...
            //     Query = Keyword Table (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF] -> Query = Keyword, Table => ActionFn(5);
            //
            pub fn __state6<
                'input,
                __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__lalrpop_util::ParseError<usize, (usize, &'input str), ()>>>,
            ...
            //     Table = r#"(?i)[a-z]+"# (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
            //
            //   ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF] -> Table = r#"(?i)[a-z]+"# => ActionFn(4);
            //
            pub fn __state7<
                'input,
                __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__lalrpop_util::ParseError<usize, (usize, &'input str), ()>>>,
    ...
    mod __parse_table {
        ...
        mod __parse__Query {
            ...
            const __ACTION: &'static [i32] = &[
                ...
                // State 2
                //     __Query = Query (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
                -6,  // on "INSERT", reduce `__Query = Query => ActionFn(0);`
                -6,  // on r#"(?i)[a-z]+"#, reduce `__Query = Query => ActionFn(0);`
                -6,  // on r#"(?i)select"#, reduce `__Query = Query => ActionFn(0);`
                -6,  // on UPDATE, reduce `__Query = Query => ActionFn(0);`

                // State 3
                //     Keyword = "INSERT" (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
                -2,  // on "INSERT", reduce `Keyword = "INSERT" => ActionFn(2);`
                -2,  // on r#"(?i)[a-z]+"#, reduce `Keyword = "INSERT" => ActionFn(2);`
                -2,  // on r#"(?i)select"#, reduce `Keyword = "INSERT" => ActionFn(2);`
                -2,  // on UPDATE, reduce `Keyword = "INSERT" => ActionFn(2);`

                // State 4
                //     Keyword = r#"(?i)select"# (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
                -1,  // on "INSERT", reduce `Keyword = r#"(?i)select"# => ActionFn(1);`
                -1,  // on r#"(?i)[a-z]+"#, reduce `Keyword = r#"(?i)select"# => ActionFn(1);`
                -1,  // on r#"(?i)select"#, reduce `Keyword = r#"(?i)select"# => ActionFn(1);`
                -1,  // on UPDATE, reduce `Keyword = r#"(?i)select"# => ActionFn(1);`

                // State 5
                //     Keyword = UPDATE (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
                -3,  // on "INSERT", reduce `Keyword = UPDATE => ActionFn(3);`
                -3,  // on r#"(?i)[a-z]+"#, reduce `Keyword = UPDATE => ActionFn(3);`
                -3,  // on r#"(?i)select"#, reduce `Keyword = UPDATE => ActionFn(3);`
                -3,  // on UPDATE, reduce `Keyword = UPDATE => ActionFn(3);`

                // State 6
                //     Query = Keyword Table (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
                -4,  // on "INSERT", reduce `Query = Keyword, Table => ActionFn(5);`
                -4,  // on r#"(?i)[a-z]+"#, reduce `Query = Keyword, Table => ActionFn(5);`
                -4,  // on r#"(?i)select"#, reduce `Query = Keyword, Table => ActionFn(5);`
                -4,  // on UPDATE, reduce `Query = Keyword, Table => ActionFn(5);`

                // State 7
                //     Table = r#"(?i)[a-z]+"# (*) ["INSERT", r#"(?i)[a-z]+"#, r#"(?i)select"#, UPDATE, EOF]
                -5,  // on "INSERT", reduce `Table = r#"(?i)[a-z]+"# => ActionFn(4);`
                -5,  // on r#"(?i)[a-z]+"#, reduce `Table = r#"(?i)[a-z]+"# => ActionFn(4);`
                -5,  // on r#"(?i)select"#, reduce `Table = r#"(?i)[a-z]+"# => ActionFn(4);`
                -5,  // on UPDATE, reduce `Table = r#"(?i)[a-z]+"# => ActionFn(4);`
            ...
            const __EOF_ACTION: &'static [i32] = &[
                ...
                -2,  // on EOF, reduce `Keyword = "INSERT" => ActionFn(2);`

                -1,  // on EOF, reduce `Keyword = r#"(?i)select"# => ActionFn(1);`

                -3,  // on EOF, reduce `Keyword = UPDATE => ActionFn(3);`
...
mod __intern_token {
    ...
    impl<'input> __Matcher<'input> {
        pub fn new(s: &'input str) -> __Matcher<'input> {
            ...
            let __regex_vec = vec![
                __regex::Regex::new("^(?u:[A-Za-zſ-ſK-K])+").unwrap(),
                __regex::Regex::new("^(?iu:insert)").unwrap(),
                __regex::Regex::new("^(?iu:select)").unwrap(),
                __regex::Regex::new("^(?iu:update)").unwrap(),
            ];
            __Matcher {
                text: s,
                consumed: 0,
