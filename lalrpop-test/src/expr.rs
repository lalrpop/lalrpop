    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            ...
            Some(__tok @ Tok::Times(..)) => {
                let mut __sym1 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state18(scale, __lookahead, __tokens, __sym0, __sym1));
            }
            Some(Tok::Minus(..)) => {
                let __sym0 = __sym0.take().unwrap();
                let __nt = super::__actions::__action3(scale, __sym0);
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            ...
            Some(__tok @ Tok::RParen(..)) => {
                let mut __sym2 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state20(scale, __lookahead, __tokens, __sym0, __sym1, __sym2));
            }
            _ => {
                return Err(__lookahead);
            }
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            Some(__tok @ Tok::Div(..)) => {
                ...
                let __lookahead = __tokens.next();
                __result = try!(__state13(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(__tok @ Tok::Times(..)) => {
                let mut __sym3 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state14(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            None => {
                let __sym0 = __sym0.take().unwrap();
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            Some(__tok @ Tok::Times(..)) => {
                let mut __sym3 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state18(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(__tok @ Tok::Div(..)) => {
                let mut __sym3 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state17(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(Tok::Minus(..)) => {
                let __sym0 = __sym0.take().unwrap();
                let __sym1 = __sym1.take().unwrap();
