    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        while __sym0.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::Factor(__nt) => {
                    let __sym1 = &mut Some(__nt);
                    __result = try!(__state14(scale, __lookahead, __tokens, __sym1));
                }
                __Nonterminal::Expr(__nt) => {
                    let __sym1 = &mut Some(__nt);
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            Some(Tok::Num(__tok0)) => {
                ...
                let __lookahead = __tokens.next();
                __result = try!(__state3(scale, __lookahead, __tokens, __sym2));
            }
            Some(__tok @ Tok::LParen(..)) => {
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            ...
            Some(__tok @ Tok::Plus(..)) => {
                let mut __sym2 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state21(scale, __lookahead, __tokens, __sym1, __sym2));
            }
            Some(__tok @ Tok::Minus(..)) => {
                let mut __sym2 = &mut Some(__tok);
                let __lookahead = __tokens.next();
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            Some(__tok @ Tok::Times(..)) => {
                let mut __sym1 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state24(scale, __lookahead, __tokens, __sym0, __sym1));
            }
            Some(__tok @ Tok::Div(..)) => {
                let mut __sym1 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state23(scale, __lookahead, __tokens, __sym0, __sym1));
            }
            Some(Tok::Minus(..)) => {
                let __sym0 = __sym0.take().unwrap();
                let __nt = super::__actions::__action3(scale, __sym0);
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            Some(__tok @ Tok::Div(..)) => {
                ...
                let __lookahead = __tokens.next();
                __result = try!(__state9(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(__tok @ Tok::Times(..)) => {
                let mut __sym3 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state8(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(Tok::Minus(..)) => {
                let __sym0 = __sym0.take().unwrap();
    ...
    ) -> Result<(Option<Tok>, __Nonterminal<>), Option<Tok>>
    {
        ...
        match __lookahead {
            Some(__tok @ Tok::Div(..)) => {
                let mut __sym3 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state23(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(__tok @ Tok::Times(..)) => {
                let mut __sym3 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state24(scale, __lookahead, __tokens, __sym2, __sym3));
            }
            Some(Tok::Plus(..)) => {
                let __sym0 = __sym0.take().unwrap();
                let __sym1 = __sym1.take().unwrap();
