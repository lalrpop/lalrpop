    ...
    >(
        ...
        match __lookahead {
            Some(__tok @ Tok::Plus(..)) => {
                ...
                let __lookahead = __tokens.next();
                __result = try!(__state15(__lookahead, __tokens, __sym1, __sym2));
            }
            ...
            Some(__tok @ Tok::Minus(..)) => {
                let mut __sym2 = &mut Some(__tok);
                let __lookahead = __tokens.next();
                __result = try!(__state17(__lookahead, __tokens, __sym1, __sym2));
            }
            _ => {
                return Err(__lookahead);
            }
    ...
    >(
        ...
        while __sym0.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::Expr(__nt) => {
                    let __sym1 = &mut Some(__nt);
                    __result = try!(__state18(__lookahead, __tokens, __sym0, __sym1));
                }
                __Nonterminal::Term(__nt) => {
                    let __sym1 = &mut Some(__nt);
                    __result = try!(__state10(__lookahead, __tokens, __sym1));
